...
export const CONTENT_PAGES = [
  {
    ...
    description:
      'HatchResume is a free online resume builder with 40+ ATS-friendly templates. No sign-up, no watermark, no subscription — and your resume never leaves your browser.',
    h1: 'About HatchResume',
    intro:
      'HatchResume (hatchresume.com) is a free online resume builder. You pick one of 40+ professional, ATS-friendly templates, type your details into the editor, and download a print-ready PDF — with no account, no watermark, and no payment step at the end.',
    sections: [
      {
        ...
        bullets: [
          '40+ free professional resume templates, including single-column ATS layouts',
    ...
    faqs: [
      {
        ...
        a: 'HatchResume is a free online resume builder at hatchresume.com. It gives you 40+ professional, ATS-friendly templates, an editor for your details, and a one-click PDF download — with no account required.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Your content is kept separately from the design, so you can move between any of the 40+ templates at any time and your details carry over.',
      },
      {
