...
A 100% free, privacy-first resume builder. Pick one of 50+ professional, ATS-friendly templates, fill in your details, and download your resume as a PDF — no sign-up, no watermark, and your data never leaves the browser.

## Features

- **50+ free professional templates** — browse them at [/templates](https://hatchresume.com/templates/), one page per design
...
- **The landing page is small.** Routes below it are `React.lazy`, so the first
  visit no longer downloads all 50 template renderers plus jsPDF and
